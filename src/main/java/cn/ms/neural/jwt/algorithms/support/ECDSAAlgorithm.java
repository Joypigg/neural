...
import cn.ms.neural.jwt.support.ECDSAKeyProvider;
...
public class ECDSAAlgorithm extends Algorithm {
    ...
    //Visible for testing
    public ECDSAAlgorithm(CryptoHelper crypto, String id, String algorithm, int ecNumberSize, ECDSAKeyProvider keyProvider) throws IllegalArgumentException {
        super(id, algorithm);
        if (keyProvider == null) {
    ...
    public ECDSAAlgorithm(String id, String algorithm, int ecNumberSize, ECDSAKeyProvider keyProvider) throws IllegalArgumentException {
    ...
    //Visible for testing
    public static ECDSAKeyProvider providerForKeys(final ECPublicKey publicKey, final ECPrivateKey privateKey) {
